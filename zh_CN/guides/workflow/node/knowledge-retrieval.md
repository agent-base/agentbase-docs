...
2. 选择需要查询的知识库，可选知识库需要在 AgentBase 知识库内预先[创建](../../knowledge-base/create-knowledge-and-upload-documents.md)；
...
> 建议将知识库的召回模式切换为多路召回，详细说明请参考[《在应用内集成知识库》](https://docs.agentbase.ai/v/zh-hans/guides/knowledge-base/integrate-knowledge-within-application)。
