...
接口方法说明见：[Interfaces](https://github.com/agent-base/agentbase/blob/main/api/core/model\_runtime/docs/zh\_Hans/interfaces.md)，具体实现可参考：[llm.py](https://github.com/agent-base/agentbase-runtime/blob/main/lib/model_providers/anthropic/llm/llm.py)。
