...
SiliconCloud 基于优秀的开源基础模型，提供高性价比的 GenAI 服务。你可以通过 **SiliconFlow** 在 AgentBase 内调用 Flux 、Stable Diffusion 绘图模型，搭建你的专属 AI 绘图应用。以下是在 AgentBase 中配置 SiliconFlow 工具的步骤。
...
在 AgentBase 的工具页中点击 `SiliconCloud > 去授权` 填写 API Key。
