...
Create a project in LangSmith. After logging in, click **New Project** on the homepage to create your own project. The **project** will be used to associate with **applications** in AgentBase for data monitoring.
...
#### 4. Integrating LangSmith with AgentBase

Configure LangSmith in the AgentBase application. Open the application you need to monitor, open **Monitoring** in the side menu, and select **Tracing app performance** on the page.
...
Once configured, the debug or production data from applications within AgentBase can be monitored in LangSmith.

<figure><img src="../../../../img/debug-app-in-agentbase.png" alt=""><figcaption><p>Debugging Applications in AgentBase</p></figcaption></figure>

When you switch to LangSmith, you can view detailed operation logs of AgentBase applications in the dashboard.
...
Detailed LLM operation logs through LangSmith will help you optimize the performance of your AgentBase application.
