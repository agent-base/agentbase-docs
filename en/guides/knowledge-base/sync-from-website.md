...
description: >-
  ...
  it into Markdown, and import it into the AgentBase knowledge base.
---

# Sync Data from Website

AgentBase's knowledge base supports web scraping and parsing into Markdown for import through integration with Firecrawl.
...
Log in to the [Firecrawl website](https://www.firecrawl.dev/) to complete registration, get your API Key, and then enter and save it in AgentBase.

<figure><img src="/en/.gitbook/assets/guides/knowledge-base/sync-from-website/image (7).png" alt=""><figcaption><p>Get the API Key and save it in AgentBase</p></figcaption></figure>
