...
If you want to customize the application shared outside, you can Fork our open source [WebApp template](https://github.com/agent-base/webapp-text-generator). Based on the template, you can moagentbase the application to meet your specific situation and style requirements.
