...
The application toolbox provides various additional features for AgentBase's [applications](../#application_type):
...
For more details, please see [Citation and Attribution](https://docs.agentbase.ai/guides/knowledge-base/retrieval-test-and-citation#id-2.-citation-and-attribution).
