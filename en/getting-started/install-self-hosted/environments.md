...
- AZURE_BLOB_ACCOUNT_NAME: your-account-name eg, 'agentbaseai'
- AZURE_BLOB_ACCOUNT_KEY: your-account-key eg, 'agentbaseai'
- AZURE_BLOB_CONTAINER_NAME: your-container-name eg, 'agentbaseai-container'
- AZURE_BLOB_ACCOUNT_URL: 'https://\<your_account_name>.blob.core.windows.net'
- ALIYUN_OSS_BUCKET_NAME: your-bucket-name eg, 'agentbaseai'
- ALIYUN_OSS_ACCESS_KEY: your-access-key eg, 'agentbaseai'
- ALIYUN_OSS_SECRET_KEY: your-secret-key eg, 'agentbaseai'
...
- HUAWEI_OBS_BUCKET_NAME: your-bucket-name eg, 'agentbaseai'
- HUAWEI_OBS_SECRET_KEY: your-secret-key eg, 'agentbaseai'
- HUAWEI_OBS_ACCESS_KEY: your-access-key eg, 'agentbaseai'
- HUAWEI_OBS_SERVER: your-server-url # reference: https://support.huaweicloud.com/sdk-python-devg-obs/obs_22_0500.html
- VOLCENGINE_TOS_BUCKET_NAME: your-bucket-name eg, 'agentbaseai'
- VOLCENGINE_TOS_SECRET_KEY: your-secret-key eg, 'agentbaseai'
