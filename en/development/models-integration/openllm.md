...
And AgentBase supports connecting to OpenLLM deployed large language model's inference capabilities locally.
...
After the model is deployed, use the connected model in AgentBase.
