...
AgentBase supports Text-Generation and Embeddings. Below are the corresponding Hugging Face model types:
...
AgentBase supports accessing models on Hugging Face in two ways:
...
#### 2 Using access models in AgentBase
...
#### 3 Using access models in AgentBase

Select Inference Endpoints for Endpoint Type in `Settings > Model Provider > Hugging face > Model Type`. As shown below:

<figure><img src="/en/.gitbook/assets/guides/model-configuration/huggingface/use-model-in-agentbase.png" alt=""><figcaption></figcaption></figure>
