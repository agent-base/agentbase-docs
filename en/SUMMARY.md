...
* [Welcome to AgentBase](README.md)
...
* [AgentBase Community](getting-started/install-self-hosted/README.md)
...
* [AgentBase Cloud](getting-started/cloud.md)
* [AgentBase Premium on AWS](getting-started/agentbase-premium-on-aws.md)
...
* [Contributing to AgentBase Documentation](community/docs-contribution.md)
...
* [Use Cases](learn-more/use-cases/README.md)
  ...
  * [Create a MidJourney Prompt Bot with AgentBase](learn-more/use-cases/create-a-midjourney-prompt-bot-with-agentbase.md)
  ...
  * [Integrating AgentBase Chatbot into Your Wix Website](learn-more/use-cases/how-to-integrate-agentbase-chatbot-to-your-wix-website.md)
* [Extended Reading](learn-more/extended-reading/README.md)
  ...
  * [How to Use JSON Schema Output in AgentBase?](learn-more/how-to-use-json-schema-in-agentbase.md)
...
* [User Agreement](policies/agreement/README.md)
  * [Terms of Service](https://agentbase.ai/terms)
  * [Privacy Policy](https://agentbase.ai/privacy)
