...
When users build AI applications with multiple knowledge bases, AgentBase's retrieval strategy will determine which content will be retrieved.
...
Tip: OpenAI Function Call now supports multiple tool calls. AgentBase will upgrade this mode to "N-of-M retrieval" in future versions. -->
